...
7. Fill **Mô tả** from the finding content (1-2 sentences) and keep the original explanatory bullets.
8. Leave **Trạng thái** and **Lý do** completely blank.
...
| **Mô tả**      | <short description from leader content> |
| **Trạng thái** |  |
| **Lý do**      |  |
...
- Missing the **Mô tả** column in the standard table.
...
- [ ] Every finding has the 4-column table: **Files**, **Mô tả**, **Trạng thái**, **Lý do** (evidence: table headers present).
