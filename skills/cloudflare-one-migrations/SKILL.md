...
description: Plans migrations from Zscaler ZIA/ZPA, Palo Alto, legacy VPN, SWG, or SASE stacks to Cloudflare One. Use when planning migration assessments, policy mapping, rollout plans, and parity/gap analysis.
---
